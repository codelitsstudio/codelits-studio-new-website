...
export const metadata: Metadata = {
  title: 'Privacy Policy – CodeLits Studio | Next-Gen Software AI, and Digital Innovation Firm',
  description: 'Read about how CodeLits Studio collects, uses, and protects your data and privacy.',
};
