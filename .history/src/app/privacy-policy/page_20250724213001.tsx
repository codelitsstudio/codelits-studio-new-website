...
<div>
  ...
  <div className="flex flex-col divide-y divide-gray-300 dark:divide-gray-700 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
    {others.map((init) => {
      ...
      return (
        <Link
          ...
          key={init.slug}
          className="group flex items-center gap-6 p-6 bg-white dark:bg-gray-900 transition-colors duration-300 hover:bg-gray-50 dark:hover:bg-gray-800"
        >
