...
export const leaders = [
  ...
  { name: 'Jori Lallo', position: 'Co-founder', avatar: '/images/bill.jpg' },
  { name: 'Tuomas Artman', position: 'Co-founder, CTO', avatar: '/images/yashu.png' },
  { name: 'Tom Moor', position: 'Head of Engineering', avatar: '/images/sub.png' },
  { name: 'Nan Yu', position: 'Head of Product', avatar: '/images/shubhek.png' },
];
