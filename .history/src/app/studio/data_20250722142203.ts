...
export const leaders = [
  { name: 'Sujan Bhatta', position: 'Co-founder, Managing Director', avatar: '/images/wewe.png' },
  { name: 'Billjesh Man Baidya', position: 'Co-founder, Director, HR administration', avatar: '/images/bill.jpg' },
  { name: 'Yashwant Raj Dhakal', position: 'Co-founder, CTO', avatar: '/images/yashu.png' },
  { name: 'Subodh Joshi', position: 'Head of Engineering', avatar: '/images/sub.png' },
  { name: 'Shubhekshya Joshi', position: 'Head of Product', avatar: '/images/shubhek.png' },
];
