    ...
    gsap.fromTo(
      ...
      { opacity: 0, y: 50 },
      {
        ...
        scrollTrigger: {
          ...
          start: 'top 85%',
          end: 'top 50%',  // define an end so scrub has a range to work with
          scrub: 0.5,      // smooth scrub, 0.5 seconds delay
          // toggleActions no longer necessary when using scrub
          // once: true is also not applicable for scrub
        },
      }
    );
  }, cardsRef);
