...
export const leaders = [
 ...
 avatar: '/images/wewe.png' },
  { name: 'Billjesh Man Baidya', position: 'Director & HR administration', avatar: '/images/bill.jpg' },
  { name: 'Yashwant Raj Dhakal', position: 'Director', avatar: '/images/yashu.png' },
  { name: 'Subodh Joshi', position: 'Director & CEARO', avatar: '/images/sub.png' },
  { name: 'Shubhekshya Joshi', position: 'Director & CPMO', avatar: '/images/shubhek.png' },
];
