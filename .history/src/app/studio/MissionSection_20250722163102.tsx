...
export default function MissionSection({ title, desc }: MissionSectionProps) {
  ...
  return (
    <section
      ref={missionRef}
      className="category-card group mx-auto relative rounded-2xl overflow-hidden border shadow-lg hover:shadow-xl transition-all duration-300 hover:border-primary/30 col-span-2 max-w-[1160px] mb-20"
    >
