...
const newsItems = [
  {
    ...
    date: 'July 15, 2025',
    image: 'https://images.unsplash.com/photo-1483058712412-4245e9b90334?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    link: '/blog/project-workflows',
  },
  {
    title: 'Remote work productivity tips',
    date: 'July 1, 2025',
    image: 'https://images.unsplash.com/photo-1507099985932-87a4520ed1d5?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    link: '/blog/remote-productivity',
  },
  {
    title: 'Scaling engineering teams effectively',
    date: 'June 20, 2025',
    image: 'https://martinfowler.com/articles/scaling-engineering-teams/scaling-teams.jpg',
    link: '/blog/scaling-teams',
  },
  {
    title: 'Designing with user feedback',
    date: 'June 5, 2025',
    image: 'https://uxdesign.cc/designing-with-user-feedback/feedback.jpg',
    link: '/blog/user-feedback',
  },
  {
    title: 'The future of software tools',
    date: 'May 25, 2025',
    image: 'https://www.techradar.com/news/future-of-software-development/software-tools.jpg',
    link: '/blog/future-software-tools',
  },
  {
    title: 'Balancing speed and quality',
    date: 'May 10, 2025',
    image: 'https://www.infoq.com/articles/speed-quality-software/speed-quality.jpg',
    link: '/blog/speed-quality',
  },
  {
    title: 'Effective team communication',
    date: 'April 30, 2025',
    image: 'https://www.atlassian.com/team-playbook/plays/communication-plan/communication.jpg',
    link: '/blog/team-communication',
  },
  {
    title: 'Integrating AI in workflows',
    date: 'April 15, 2025',
    image: 'https://hbr.org/resources/images/article_assets/2023/01/ai-workflows.jpg',
    link: '/blog/ai-integration',
  },
  {
    title: 'Security best practices for teams',
    date: 'April 1, 2025',
    image: 'https://www.cisa.gov/sites/default/files/styles/hero_image/public/security-practices.jpg',
...
<section className="mb-20 w-full pt-16 pb-32 relative overflow-hidden">
  ...
  <div className="max-w-6xl mx-auto px-4 relative z-20">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      {teamMembers.map(({ name, position, avatar }) => (
        <div key={name + '-general'} className="group">
          <div className="w-32 aspect-square rounded-xl overflow-hidden group">
            <Image
              src={avatar}
              alt={name}
