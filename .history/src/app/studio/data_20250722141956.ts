...
export const leaders = [
  { name: 'Karri Saarinen', position: 'Co-founder, CEO', avatar: '/images/wewe.png' },
  { name: 'Jori Lallo', position: 'Co-founder', avatar: '/images/leaders/bill.jpg' },
  { name: 'Tuomas Artman', position: 'Co-founder, CTO', avatar: '/images/leaders/yashu.png' },
  { name: 'Tom Moor', position: 'Head of Engineering', avatar: '/images/leaders/sub.png' },
  { name: 'Nan Yu', position: 'Head of Product', avatar: '/images/leaders/shubhek.png' },
];
