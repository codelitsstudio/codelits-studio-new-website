...
export const metadata: Metadata = {
  title: 'Blog – CodeLits Studio | Next-Gen Software AI, and Digital Innovation Firm',
  description: 'Read insightful articles and updates on software development, AI, and tech trends.',
};
