    ...
    <section ref={heroRef} className="relative py-20 md:py-32 overflow-hidden bg-background">
      {showPopup && (
        <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center px-4">
          ...
          >
            <h2 className="text-xl font-semibold mb-3">Heads Up!</h2>
            <p className="mb-4">
              This website is currently under development and not fully published.
              <br />
              If you'd like to view our previous site, please use the button below.
            </p>
