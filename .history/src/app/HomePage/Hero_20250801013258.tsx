...
export default function Hero() {
  ...
  // Initialize showPopup state from localStorage
  const [showPopup, setShowPopup] = useState(() => {
    if (typeof window !== 'undefined') {
      return localStorage.getItem('popupDismissed') !== 'true';
    }
    return true; // default to show on server render or no localStorage
  });
  ...
  useEffect(() => {
    ...
    // On close, set flag in localStorage to prevent future popups
