...
export default function Hero() {
  ...
  // Start with null - means "not decided yet"
  ...
  useEffect(() => {
    if (showPopup === null) return; // don't run animations until state known
  ...
  // While we don't know if popup should show or not, render null to avoid flicker
        ...
        <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center px-4">
          ...
          >
            ...
            <div className="flex justify-center gap-3 mt-5 flex-col sm:flex-row">
              <Button
                className="text-sm px-4 py-2 font-normal text-black dark:text-white"
