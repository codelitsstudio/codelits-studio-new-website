...
<section
  ref={missionRef}
  className="category-card group relative rounded-2xl overflow-hidden border shadow-lg hover:shadow-xl transition-all duration-300 hover:border-primary/30 col-span-2 max-w-5xl mx-auto mb-20"
>
  <div className="relative z-10 flex flex-col h-full p-8 justify-between">
    <div className="max-w-[600px]">
      <div className="mb-4 flex h-12 w-12 items-center  rounded-lg bg-primary/10">
        <BookOpen className="h-6 w-6 text-primary" />
      </div>
      <h2 className="font-headline text-3xl font-bold text-white">{missionTitle}</h2>
      <p className="mt-4 text-lg text-muted-foreground">{missionDesc}</p>
    </div>
