...
<p className="mt-2 text-muted-foreground">{desc}</p>
  ...
  <Button asChild size="lg" variant="outline">
    <Link href="/careers">Get Hired →</Link>
        ...
        {/* Team Grid Section */}
<section className="mb-20 bg-[#080808] w-full relative overflow-hidden pb-24">  {/* Added pb-24 */}
  {/* Blur overlay on top */}
  <div
    className="absolute top-0 left-0 w-full h-24 z-10 pointer-events-none"
    style={{
      background:
        'linear-gradient(to bottom, #080808 0%, rgba(8,8,8,0.6) 60%, rgba(8,8,8,1) 100%)',
