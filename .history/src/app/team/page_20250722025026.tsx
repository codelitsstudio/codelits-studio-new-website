...
<GridPattern
  ...
  x={-1}
  y={-1}
  className="grid-pattern absolute inset-0 h-full w-full stroke-primary/10 z-0 blur-sm opacity-40 [mask-image:linear-gradient(to_bottom,white_90%,transparent)]"
/>
