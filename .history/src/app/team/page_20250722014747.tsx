...
<section className="relative py-20 overflow-hidden bg-background">
  ...
  <div className="pointer-events-none absolute inset-0 z-0 w-screen h-full">
    <GridPattern
      width={40}
      height={40}
      x={-1}
      y={-1}
      className="w-full h-full stroke-primary/10 [mask-image:linear-gradient(to_bottom,white_10%,transparent_90%)]"
    />
  </div>
