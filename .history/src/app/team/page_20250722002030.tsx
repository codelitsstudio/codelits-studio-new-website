...
export default function StudioPage() {
  ...
  // GSAP entry animation for story section
  useEffect(() => {
    ...
    <main className="bg-[#0E0E0E] text-white">
      ...
      <section className="relative h-[50vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
          <h1 className="text-5xl md:text-6xl font-bold">Studio</h1>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-16 space-y-24">
        ...
        <section ref={sectionRef} className="max-w-3xl mx-auto prose prose-invert text-center">
          ...
          <p>
            We're crafting the project planning tool for teams that care about quality. Computers used
            to be magical. But much of that magic has been lost over time, replaced by subpar tools
            and practices that slow teams down and hold back great work.
          </p>
          <p>
            Frustrated with the status quo, we decided to build something better. Something that teams
            would actually enjoy using. We named it Linear to signify progress.
          </p>
          <p>
            Today, thousands of teams around the globe use Linear to build their products. Linear helps
            them to focus on what they do best: crafting software experiences that feel magical again.
          </p>
        </section>
        ...
        {/* TODO: Add Manifesto, Backers, News & CTA sections below, using the same gsap/ScrollTrigger fade-ins */}
      </div>
    </main>
  );
}
