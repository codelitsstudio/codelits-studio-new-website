...
<section className="mb-20 w-full pt-16 pb-32 relative overflow-hidden">
  ...
  <div className="max-w-6xl mx-auto px-4 relative z-20">
    ...
    {/* Leaders Heading */}
    <h2 className="font-headline text-3xl mt-10 font-bold mb-8 text-center text-white">
      Meet the <span className="text-primary underline">Leaders</span> behind
    </h2>
    ...
    <h2 className="font-headline text-3xl mt-10 font-bold mb-8 text-center text-white">
      Meet the <span className="text-primary underline">Crew</span>
    </h2>
