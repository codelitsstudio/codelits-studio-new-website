...
<section className="relative py-20 overflow-hidden">
  {/* GridPattern background covering full width of screen */}
  <div className="absolute inset-0 -z-10">
    <GridPattern
      ...
      x={-1}
      y={-1}
      className="absolute -top-1/4 left-0 h-full w-full stroke-primary/10 [mask-image:linear-gradient(to_bottom,white_10%,transparent_100%)]"
    />
  </div>
