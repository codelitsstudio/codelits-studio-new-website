...
const teamMembers = [
  { name: 'Karri Saarinen', position: 'Co-founder, CEO', avatar: 'https://source.unsplash.com/64x64/?face,man' },
  { name: 'Jori Lallo', position: 'Co-founder', avatar: 'https://source.unsplash.com/64x64/?face,woman' },
  { name: 'Tuomas Artman', position: 'Co-founder, CTO', avatar: 'https://source.unsplash.com/64x64/?face,tech' },
  { name: 'Tom Moor', position: 'Head of Engineering', avatar: 'https://source.unsplash.com/64x64/?face,engineer' },
  { name: 'Nan Yu', position: 'Head of Product', avatar: 'https://source.unsplash.com/64x64/?face,product' },
  { name: 'Cristina Cordova', position: 'COO', avatar: 'https://source.unsplash.com/64x64/?face,ceo' },
  { name: 'Casey Bertenthal', position: 'Head of Sales', avatar: 'https://source.unsplash.com/64x64/?face,sales' },
];
