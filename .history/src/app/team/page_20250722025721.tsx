...
{teamMembers.map(({ name, position, avatar }, index) => (
  <div
    key={name}
    className={`group ${index === 4 ? 'col-span-4 flex justify-center' : ''}`}
  >
    ...
    <div className={`mt-4 flex items-center gap-14 ${index === 4 ? 'justify-center' : 'justify-start'}`}>
      <div>
