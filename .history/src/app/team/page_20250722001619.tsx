...
// Team members data - add your own images in /public/images/team/
const teamMembers = [
  ...
  return (
    <main className="container mx-auto px-4 py-16 md:py-24 space-y-24">
      ...
      <header className="text-center max-w-3xl mx-auto">
        <h1 className="text-5xl font-bold tracking-tight mb-4">Studio</h1>
      ...
      <section className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-semibold mb-8 text-center">Built for the Best - Backed by the Best</h2>
