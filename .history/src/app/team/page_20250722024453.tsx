...
<p className="mt-2 text-muted-foreground">{desc}</p>
  ...
  <Button asChild size="lg" variant="outline">
    <Link href="/careers">Get Hired →</Link>
        ...
        {/* Team Grid Section */}
<section className="mb-20 w-full relative overflow-hidden">
  {/* Blur overlay */}
      <GridPattern
        width={40}
        height={40}
        x={-1}
        y={-1}
        className="grid-pattern absolute left-0 h-full w-full stroke-primary/10 [mask-image:linear-gradient(to_bottom,white_10%,transparent_90%)]"
      />
