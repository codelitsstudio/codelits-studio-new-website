...
/>
  ...
  <div className="max-w-6xl mx-auto px-4 relative z-20">
    <h2 className="font-headline text-2xl mt-10 font-bold mb-20 text-center text-white">
      Meet the <span className="text-primary text-3xl underline">Leaders</span> behind Codelits Studio
    </h2>
