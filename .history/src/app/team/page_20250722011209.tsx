...
const teamMembers = [
  ...
  // ... (rest of team members same as before)
];

const backers = [
  // ... (backers same as before)
];

const newsItems = [
  // ... (news items same as before)
];
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden" ref={sectionRef}>
      <div className="container relative mx-auto px-4 py-16 md:py-24">
        ...
        {/* Team Grid Section */}
        <section className="max-w-6xl mx-auto mb-20">
          <h2 className="font-headline text-3xl font-bold mb-10 text-center text-white">
            Meet the Team
          </h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {teamMembers.map(({ name, position, avatar }) => (
              <div
                key={name}
                className="group relative rounded-lg overflow-hidden border border-primary/20 bg-background p-3 text-center hover:border-primary/40 transition-colors"
              >
                <div className="w-20 h-20 rounded-full overflow-hidden mx-auto border border-primary/20 group-hover:border-primary/40 transition-colors">
                  <Image
                    src={avatar}
                    alt={name}
                    width={80}
                ...
                <p className="mt-3 font-semibold text-sm text-white group-hover:text-primary transition-colors">
                  {name}
                </p>
