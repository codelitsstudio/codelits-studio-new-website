...
<GridPattern
  ...
  x={-1}
  y={-1}
  className="grid-pattern absolute inset-0 h-full w-full stroke-primary/10 opacity-50 z-0 [mask-image:linear-gradient(to_bottom,white_30%,rgba(255,255,255,0.1)_70%,transparent_100%)]"
/>
