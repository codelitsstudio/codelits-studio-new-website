...
export const metadata: Metadata = {
  title: 'Process – CodeLits Studio | Next-Gen Software AI, and Digital Innovation Firm',
  description: 'Learn about the creative and technical processes behind our successful projects.',
};
