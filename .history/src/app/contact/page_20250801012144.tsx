...
export const metadata: Metadata = {
  title: 'Contact – CodeLits Studio | Next-Gen Software AI, and Digital Innovation Firm',
  description: 'Get in touch with CodeLits Studio for collaborations, inquiries, and support.',
};
