...
export const metadata: Metadata = {
  title: 'Services – CodeLits Studio | Next-Gen Software AI, and Digital Innovation Firm',
  description: 'Explore our software, mobile, and AI development services offered by CodeLits Studio.',
};
      ...
      <div className="mt-24 bg-card p-8 md:p-12 rounded-2xl">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden md:block">
            <Image 
              src="/illustrations/projectinmind-2.png"
              alt="Team discussion"
              width={600}
              height={400}
