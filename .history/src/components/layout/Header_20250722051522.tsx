...
export function Header() {
  ...
  // Declare all hooks at the top, before any early return
...
if (!hasMounted || isAdminPath) return null;
  useEffect(() => {
  ...
  return (
    <header ref={headerRef} className="sticky top-0 z-50 w-full p-2 md:p-4">
      ...
      <div
        ref={loaderRef}
        className="absolute bottom-0 left-0 h-[4px] bg-primary origin-left"
