...
const runLoaderAnimation = () => {
  ...
  // Reset: width 0, height small (say 2px), visible
  gsap.set(loader, { width: 0, height: 2, autoAlpha: 1 });

  // Animate width to 100% and height to 4px simultaneously over 2.5 seconds
  gsap.to(loader, {
    width: "100%",
    height: 4,
    duration: 2.5,
