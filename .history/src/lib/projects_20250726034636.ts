...
export const allProjects: Project[] = [
  {
    ...
    tags: ['Web Design', 'Gaming','Website', 'Community'],
    ...
    category: 'Client Work',
      ...
      {
  slug: 'playxio-app',
  title: 'Playxio Mobile App',
  description: 'A mobile app companion for Playxio, offering seamless access to games, social features, and updates on the go.',
  longDescription: 'Playxio Mobile App is designed as a sleek companion to the Playxio gaming platform, providing users with easy access to their game library, community interactions, and real-time updates. The app delivers an immersive mobile gaming experience with a clean UI optimized for smartphones, connecting gamers anytime, anywhere.',
  image: '/images/playxio-mobile-app.png', 
  hint: 'gaming mobile app',
  link: 'https://play.google.com/store/apps/details?id=com.codelitsstudio.playxiopreregisterapp&hl=en', 
  tags: ['Mobile App', 'Gaming', 'Community', 'UX/UI Design'],
  category: 'Client Work',
},
  {
    slug: 'nexus',
  ...
  category: 'Client Work',
  },
   {
    ...
    image: '/images/noteswift-app.png',
    hint: 'nature environment website',
    link: 'https://play.google.com/store/apps/details?id=com.noteswift&hl=en',
