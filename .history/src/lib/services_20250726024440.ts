...
import {
  ...
  Repeat,
  BarChart2,
} from 'lucide-react'; // or your icon pack
...
export type Service = {
  ...
  image: string;
  hint: string;
  keyFeatures: FeatureItem[]; // Changed from string[]
...
keyFeatures: [
  { title: 'Custom-Built Architecture', icon: Architecture },
  { title: 'Cross-Platform Compatibility', icon: MonitorCheck },
  ...
  { title: 'Desktop Software Development', icon: Desktop },
  { title: 'Data Management & Analytics', icon: Database },
  { title: 'Maintenance & Version Control', icon: BarChart2 },
